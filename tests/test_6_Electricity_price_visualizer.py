import pandas as pd
from application.electricity_price_visualization import create_pandas_dataframe, create_pandas_table, create_plotly_chart, create_chart

# Exempeldata för testning
sample_data = [
    {
        "time_start": "2023-11-05T00:00:00Z",
        "SEK_per_kWh": 40.0
    },
    {
        "time_start": "2023-11-05T01:00:00Z",
        "SEK_per_kWh": 45.0
    },
...
def test_create_plotly_chart():
    # Skapa en exempel Pandas DataFrame
    data = {'Tidpunkt på dygnet i (hh:mm)': ['00:00', '01:00', '02:00'],
